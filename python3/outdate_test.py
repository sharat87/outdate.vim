...
class TestReformat(unittest.TestCase):
    def test_reformat_iso_us(self):
        final_line = outdate.reformat_date('Dated 2000-01-31.', 0, [ISO_FORMAT], US_FORMAT)
        self.assertEqual(final_line, 'Dated 01/31/2000.')

    def test_reformat_iso_uk(self):
        final_line = outdate.reformat_date('Dated 2000-01-31.', 0, [ISO_FORMAT], UK_FORMAT)
        self.assertEqual(final_line, 'Dated 31/01/2000.')

    def test_reformat_iso_oracle(self):
        final_line = outdate.reformat_date('Dated 2000-01-31.', 0, [ISO_FORMAT], ORACLE_FORMAT)
        self.assertEqual(final_line, 'Dated 31-Jan-2000.')

    def test_reformat_uk_us(self):
        final_line = outdate.reformat_date('Dated 31/01/2000.', 0, [UK_FORMAT], US_FORMAT)
        self.assertEqual(final_line, 'Dated 01/31/2000.')
